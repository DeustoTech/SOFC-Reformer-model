function [new_DataSet_2] = smoothDATASOFC(DataSet,namepic)
%
...
for ivar = new_DataSet.Properties.VariableNames
   new_DataSet_2.(ivar{:}) = new_DataSet.(ivar{:})(1:floor(windowAverage):length(new_myDateTime));
end
new_DataSet_2 = struct2table(new_DataSet_2);

%% 
if exist('namepic','var')
    clf
    i = 0;
