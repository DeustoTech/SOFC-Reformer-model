...
%% Data Set
[Inputs,Outputs,numFeatures,numResponses,ndata,mu_dt,st_dt] = cs2narxformat_dt(ics,no,ni,nd);
%%
...
for it = 1:Ntt
     ...
     Output_predic_1step_dt = predict(net,reshape([Input0 xx(:)']',numFeatures,1,1,1));
     Output_predic_1step_dt = Output_predic_1step_dt.*st_dt + mu_dt;
     ...
     Output_predic_1step = Output0(1,:) + Output_predic_1step_dt;
